  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] flex flex-col selection:bg-amber-200 selection:text-amber-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 inset-x-0 h-screen overflow-hidden pointer-events-none flex justify-center">
        ...
        <div className="absolute top-[-10%] left-[-5%] w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-rose-200/20 rounded-full blur-[120px] mix-blend-multiply" />
      </div>

      <main className="flex-1 flex flex-col items-center px-4 py-20 md:py-32 relative z-10 w-full">
        <LandingHero />

        <div className="w-full max-w-7xl mt-8">
          <Suspense fallback={<div className="h-40 rounded-3xl bg-white/60 animate-pulse" />}>
